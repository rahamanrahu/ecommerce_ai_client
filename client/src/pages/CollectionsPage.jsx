...
const PRODUCTS = [
  // Tech
  { id:1, name:"ProMax Wireless Earbuds",    category:"Tech",      price:89,  originalPrice:129, rating:4.8, reviews:2341, badge:"Best Seller", color:"#6366f1", emoji:"🎧", desc:"Premium sound with 40h battery life, active noise cancellation, and IPX5 water resistance. Crystal clear calls with dual-mic setup. Available in Midnight Black and Arctic White.", tags:["Wireless","ANC","Waterproof"] },
  { id:2, name:"UltraSlim Laptop Stand",     category:"Tech",      price:49,  originalPrice:65,  rating:4.6, reviews:876,  badge:"Popular",     color:"#3b82f6", emoji:"💻", desc:"Aircraft-grade aluminium stand compatible with all laptops 10–17 inches. Adjustable 6 angles, foldable for travel, improves airflow and reduces neck strain by 60%.", tags:["Ergonomic","Aluminum","Foldable"] },
  { id:3, name:"SmartCharge 20K Power Bank", category:"Tech",      price:65,  originalPrice:80,  rating:4.7, reviews:1543, badge:null,           color:"#0ea5e9", emoji:"🔋", desc:"20,000mAh fast-charge power bank with USB-C PD 65W, 2× USB-A 18W, and LED display. Charges your laptop, phone, and tablet simultaneously.", tags:["65W PD","Display","Dual USB"] },
  { id:4, name:"MechKeyboard Pro RGB",       category:"Tech",      price:149, originalPrice:199, rating:4.9, reviews:3201, badge:"Top Rated",    color:"#8b5cf6", emoji:"⌨️", desc:"Tenkeyless mechanical keyboard with hot-swappable switches, per-key RGB, PBT double-shot keycaps, and USB-C detachable cable. Tactile satisfying clicks.", tags:["Hot-swap","RGB","PBT Keys"] },
  { id:5, name:"4K Webcam Ultra HD",         category:"Tech",      price:119, originalPrice:159, rating:4.5, reviews:654,  badge:null,           color:"#06b6d4", emoji:"📷", desc:"Sony sensor 4K webcam with auto-focus, HDR, stereo microphones, and privacy shutter. Plug-and-play on Windows, Mac, and Linux.", tags:["4K","Autofocus","HDR"] },
  // Fashion
  { id:6, name:"Minimalist Tote Bag",        category:"Fashion",   price:75,  originalPrice:95,  rating:4.7, reviews:1102, badge:"Trending",    color:"#f59e0b", emoji:"👜", desc:"Full-grain leather tote with canvas lining, 3 inner pockets, and detachable zip pouch. Fits a 15-inch laptop. Handcrafted with ethically sourced materials.", tags:["Leather","Sustainable","Laptop Fit"] },
  { id:7, name:"Premium Sneakers OG",        category:"Fashion",   price:185, originalPrice:220, rating:4.8, reviews:4320, badge:"Iconic",       color:"#ec4899", emoji:"👟", desc:"Retro-inspired silhouette with cloud-foam insole, breathable mesh upper, and vulcanized rubber sole. Limited colorways drop monthly. Sizes 36–47.", tags:["Cloud-Foam","Mesh","Limited"] },
  { id:8, name:"Oversized Hoodie Classic",   category:"Fashion",   price:68,  originalPrice:85,  rating:4.6, reviews:2876, badge:null,           color:"#6366f1", emoji:"🧥", desc:"400gsm heavyweight fleece, pre-shrunk, double-stitched hems. Available in 8 colourways. Ethically manufactured in Portugal. Machine washable.", tags:["400gsm","Fleece","Ethical"] },
  { id:9, name:"Silk Scarf Collection",      category:"Fashion",   price:55,  originalPrice:70,  rating:4.5, reviews:432,  badge:null,           color:"#a855f7", emoji:"🧣", desc:"100% mulberry silk, hand-rolled edges, printed with original artwork by independent artists. 90×90 cm. Includes branded gift box.", tags:["Silk","Artisan","Gift Box"] },
  // Home
  { id:10, name:"Aroma Diffuser Luna",       category:"Home",      price:45,  originalPrice:60,  rating:4.8, reviews:1876, badge:"Loved",        color:"#22c55e", emoji:"🕯️", desc:"Ultrasonic mist diffuser with 7-colour ambient light, 500ml tank, whisper-quiet operation, and 8-hour timer. Includes 3 essential oil samples.", tags:["Ultrasonic","7-Color","8hr Timer"] },
  { id:11, name:"Modular Shelf System",      category:"Home",      price:220, originalPrice:280, rating:4.7, reviews:543,  badge:"New",          color:"#84cc16", emoji:"🪴", desc:"Tool-free modular shelving, 9 interchangeable panels, 60kg max load. Walnut veneer finish, FSC certified wood. Ships flat, assembles in 20 minutes.", tags:["Modular","FSC Wood","No Tools"] },
  { id:12, name:"Weighted Blanket 8kg",      category:"Home",      price:89,  originalPrice:115, rating:4.9, reviews:2104, badge:"Top Rated",    color:"#14b8a6", emoji:"🛏️", desc:"Glass-bead filled 8kg weighted blanket proven to reduce anxiety. Breathable cotton cover, removable and machine washable. Available in 4 calming colours.", tags:["Glass Beads","Cotton","Washable"] },
  // Fitness
  { id:13, name:"Smart Yoga Mat Pro",        category:"Fitness",   price:95,  originalPrice:120, rating:4.6, reviews:987,  badge:null,           color:"#f97316", emoji:"🧘", desc:"6mm thick TPE foam with alignment guides and body position zones. Anti-slip on both sides. Comes with carrying strap and QR code linking to 50 guided sessions.", tags:["TPE","Alignment","Anti-slip"] },
  { id:14, name:"Adjustable Dumbbell Set",   category:"Fitness",   price:320, originalPrice:450, rating:4.8, reviews:3421, badge:"Best Buy",     color:"#ef4444", emoji:"🏋️", desc:"Single handle adjusts from 5–52.5 lbs in 2.5 lb increments. Replaces 15 separate dumbbells. Weight selector dial, durable urethane coating, included tray.", tags:["Adjustable","Space-Saving","52.5lbs"] },
  { id:15, name:"Resistance Band Kit",       category:"Fitness",   price:35,  originalPrice:45,  rating:4.5, reviews:2341, badge:null,           color:"#fb923c", emoji:"💪", desc:"5-band progressive resistance set (10–50 lbs), fabric covered, anti-snap latex. Includes door anchor, handles, ankle straps, and carry bag. Workout guide included.", tags:["5 Bands","Anti-snap","Full Kit"] },
  // Books
  { id:16, name:"The Design Thinker",        category:"Books",     price:28,  originalPrice:35,  rating:4.9, reviews:1234, badge:"Must Read",    color:"#6366f1", emoji:"📖", desc:"Award-winning guide to human-centered design by global IDEO principals. 320 pages of frameworks, case studies from Apple, Airbnb, and IDEO. Hardcover, illustrated.", tags:["Hardcover","Illustrated","Award-Win"] },
  { id:17, name:"Atomic Focus Journal",      category:"Books",     price:22,  originalPrice:28,  rating:4.7, reviews:876,  badge:null,           color:"#8b5cf6", emoji:"📓", desc:"200-page guided productivity journal with habit trackers, weekly reviews, and gratitude prompts. Lay-flat binding, dotted grid, 100gsm acid-free paper.", tags:["Dotted Grid","Lay-flat","100gsm"] },
  { id:18, name:"Zero to One Masterclass",   category:"Books",     price:18,  originalPrice:24,  rating:4.8, reviews:5432, badge:"Bestseller",   color:"#0ea5e9", emoji:"🚀", desc:"Peter Thiel's seminal startup bible. Notes on startups, or how to build the future. Updated 10th anniversary edition with a new foreword and exclusive case studies.", tags:["Startup","10th Edition","Classic"] },
];
        ...
        <div className="modal-layout">
          ...
          <div className="modal-detail-side">
            ...
            <div className="modal-price-row">
              ...
              {product.originalPrice > product.price && (
                <>
                  <span className="product-original modal-original">${product.originalPrice}</span>
                  <span className="modal-save-badge">Save ${product.originalPrice - product.price}</span>
                </>
              )}
            </div>
